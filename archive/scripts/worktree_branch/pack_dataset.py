...
def main():
    ...
    parser.add_argument("--reps_file",  type=str,
                        default="data/messidor2/train_reps_retfound.pt")
    parser.add_argument("--out_file",   type=str,
                        default="data/messidor2/train_packed_retfound.pt")
    ...
    print("\nUpload this file to Google Drive at MyDrive/jit_rcdm/train_packed_retfound.pt")
