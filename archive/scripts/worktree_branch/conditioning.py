...
Conditioning utilities for the JiT-RCDM denoiser.
...
# RCDM conditioned a UNet via ConditionalBatchNorm2d (2-D spatial feature maps).
# AdaLNZero works on 1-D token sequences (B, N, D) — mandatory for a ViT backbone.
